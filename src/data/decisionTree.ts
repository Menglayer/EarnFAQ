...
export const decisionTree: Record<string, DecisionNode> = {
  ...
  q7: {
    ...
    yes: result(false, '薅羊毛大军太多，收益会被稀释', 'Too many airdrop farmers, yields will be diluted'),
    no: 'q8',
  },
  q8: {
    id: 'q8',
  ...
  q12: {
    id: 'q12',
    question: '你今天进门是迈的左脚吗？',
    questionEn: 'Did you step through the door with your left foot today?',
    special: 'easter-egg',
